...
gmt psscale -Dg19.3/-27.7+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg0.1f0.02a0.2+l"Colormap: 'spellbound' gradient from Restless Concepts, graphics designers [-T1.8/3.4, continuous, RGB, 20 segments]" \
...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f16p,19,purple4+jLB >> $ps << EOF
23.1 -22.5 B  O  T  S  W  A  N  A
EOF
#
gmt pstext -R -J -N -O -K \
-F+f15p,20,darkgoldenrod1+jLB -Ghotpink3@60 >> $ps << EOF
