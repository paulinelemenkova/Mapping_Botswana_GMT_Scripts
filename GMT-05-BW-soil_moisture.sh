...
gmt makecpt -Cprecipitation_monthly.cpt -V -T0/131 > pauline.cpt

ps=BW_soil.ps
# Make background transparent image
gmt grdimage bw_soil.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
