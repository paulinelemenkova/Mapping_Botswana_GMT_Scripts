...
# gmt makecpt -Cprecip2_17lev -V -T14/190 > pauline.cpt
gmt makecpt -Cprecip2_15lev.cpt -V -T14/190 > pauline.cpt

ps=BW_precip.ps
gmt grdimage bw_precip.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -t30 -P -K > $ps
