...
gmt makecpt -Cqual-mixed-12.cpt -V -T-3.7/6.40 > pauline.cpt

ps=BW_PDSI.ps
# Make background transparent image
gmt grdimage bw_pdsi.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f12p,25,black+jLB -Gdodgerblue3@90 >> $ps << EOF
...
#
gmt pstext -R -J -N -O -K \
-F+f17p,20,darkbrown+jLB -Gmistyrose@50 >> $ps << EOF
