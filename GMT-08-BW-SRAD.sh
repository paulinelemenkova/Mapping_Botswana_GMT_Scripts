...
gmt makecpt -C25_mac_style.cpt -V -T234/326 > pauline.cpt

ps=BW_SRAD.ps
# Make background transparent image
gmt grdimage bw_srad.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
