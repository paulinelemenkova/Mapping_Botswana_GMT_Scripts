...
gmt makecpt -Ctemp-c -V -T25.8/38.10 > pauline.cpt

ps=BW_Tmax.ps
# Make background transparent image
gmt grdimage bw_tmax.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
